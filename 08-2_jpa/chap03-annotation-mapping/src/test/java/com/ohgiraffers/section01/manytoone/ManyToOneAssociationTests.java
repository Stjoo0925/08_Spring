...
//     *  cascade = CascadeType.PERSIST 옵션을 사용하면 부모 엔티티를 저장할 때 자식 엔티티도 함께 영속화된다.
//     */
//
//    @Test
...
//        transaction.commit();
//
//        MenuAndCategory founMenuAndCategory = em.find(MenuAndCategory.class,999);
