...
public class FileUpLoadController {
    ...
    public String singleFileUpload(@RequestParam MultipartFile singleFile,
        ...
        if (!resource.exists()) {
            ...
            // 절대경로 : D드라이브로 부터 시작하는 경로
            // 상대경로 : 프로젝트로 부터 시작되는 경로(현재 프로젝트의 경로로 부터 시작된다)
            // getAbsolutePath : 파일의 경로를 절대경로로 바꿔주는 메서드
        ...
        // 파일의 용량이 크거나 네트워크가 끊겼을때를 대비하여 예외 처리
        try {
